        ...
        stage('Selenium Tests') {
            container('jdk') {
              stage('Selenium Tests') {
                  ...
                  curl -X GET http://admin:$(echo -ne $NEXUS_ADMIN_PASS)@nexus.eks.minlab.com/repository/maven-snapshots/${groupID}/${appName}/${appVersion}/${appName}-${appVersion}.jar --output ${appName}-${appVersion}.jar
