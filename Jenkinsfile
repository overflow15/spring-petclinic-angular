        ...
        stage('DinD') {
            container('docker') {
              stage('Docker Build') {
                  sh '''
                  apk --update add curl
                  curl -O spring-petclinic-angular-8.0.1.tgz "http://admin:$NEXUS_ADMIN_PASS@nexus.eks.minlab.com/repository/npm/spring-petclinic-angular/-/spring-petclinic-angular-8.0.1.tgz"
